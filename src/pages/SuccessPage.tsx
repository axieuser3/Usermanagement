  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white border-4 border-black rounded-none shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] p-8 text-center">
        <div className="inline-flex items-center justify-center w-24 h-24 bg-black text-white rounded-none mb-8">
          <CheckCircle className="w-12 h-12" />
        </div>
        
        <h1 className="text-3xl font-bold text-black mb-6 uppercase tracking-wide">
          PAYMENT SUCCESS!
        </h1>
